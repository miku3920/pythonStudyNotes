...
file = open('c:\\帳號密碼.json', mode='r',encoding="utf-8")
all_of_it = file.read()
file.close()
jsondata=json.loads(all_of_it)
帳號=jsondata["帳號"]
密碼=jsondata["密碼"]
商品代號=jsondata["商品代號"]
...
class FrameLogin(Frame):
    ...
    def createWidgets(self):
        ...
        self.VtextID= tk.StringVar()
        self.textID = Entry(self, textvariable=self.VtextID)
        ...
        self.VtextPassword= tk.StringVar()
        self.textPassword = Entry(self, textvariable=self.VtextPassword)
        self.textPassword["width"] = 50
        self.textPassword['show'] = '*'
        self.VtextPassword.set(密碼)
        ...
        self.buttonLogin_Click()            #  按下[登入]按鈕    123123 報價連線
